...
use Closure;
use Tungnt\Admin\Auth\Database\Menu;
use Tungnt\Admin\Controllers\AuthController;
use Tungnt\Admin\Layout\Content;
use Tungnt\Admin\Traits\HasAssets;
use Tungnt\Admin\Widgets\Navbar;
...
class Admin
{
     ...
     * @param Closure $callable
     *
     * @return \Tungnt\Admin\Layout\Content
     *
     * @deprecated since v1.6.1
     */
     ...
     * Get navbar object.
     *
     * @return \Tungnt\Admin\Widgets\Navbar
     */
    ...
    public function routes()
    {
        ...
        app('router')->group($attributes, function ($router) {
            ...
            $router->namespace('\Tungnt\Admin\Controllers')->group(function ($router) {
