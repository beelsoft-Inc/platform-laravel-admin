...
namespace Tungnt\Admin\Form;

use Tungnt\Admin\Admin;
use Tungnt\Admin\Form;
use Tungnt\Admin\Widgets\Form as WidgetForm;
...
class NestedForm
{
    ...
    /**
     * @var \Tungnt\Admin\Form|\Tungnt\Admin\Widgets\Form
     */
    protected $form;
    ...
    protected function prepareRecord($record)
    {
        ...
        foreach ($this->fields as $field) {
            ...
            if (($field instanceof \Tungnt\Admin\Form\Field\Hidden) || $value != $field->original()) {
                if (is_array($columns)) {
