...
namespace Tungnt\Admin\Controllers;

use Tungnt\Admin\Actions\Action;
use Tungnt\Admin\Actions\GridAction;
use Tungnt\Admin\Actions\Response;
use Tungnt\Admin\Actions\RowAction;
use Tungnt\Admin\Widgets\Form;
use Exception;
...
class HandleController extends Controller
{
    ...
    public function handleSelectable(Request $request)
    {
        ...
        if (class_exists($class)) {
            /** @var \Tungnt\Admin\Grid\Selectable $selectable */
