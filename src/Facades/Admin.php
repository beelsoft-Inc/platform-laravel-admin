...
namespace Tungnt\Admin\Facades;
 ...
 * Class Admin.
 *
 * @method static \Tungnt\Admin\Grid grid($model, \Closure $callable)
 * @method static \Tungnt\Admin\Form form($model, \Closure $callable)
 * @method static \Tungnt\Admin\Show show($model, $callable = null)
 * @method static \Tungnt\Admin\Tree tree($model, \Closure $callable = null)
 * @method static \Tungnt\Admin\Layout\Content content(\Closure $callable = null)
 ...
 *
 * @see \Tungnt\Admin\Admin
 */
class Admin extends Facade
{
    protected static function getFacadeAccessor()
    {
        return \Tungnt\Admin\Admin::class;
    }
}
